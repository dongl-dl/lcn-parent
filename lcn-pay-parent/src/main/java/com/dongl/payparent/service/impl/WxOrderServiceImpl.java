...
import com.dongl.payparent.config.WeChatConfig;
import com.dongl.payparent.config.WeChatIdKey;
import com.dongl.payparent.domain.wxpay.PayResult;
import com.dongl.payparent.domain.wxpay.PreOrder;
import com.dongl.payparent.domain.wxpay.PreOrderResult;
import com.dongl.payparent.service.WxOrderService;
import com.dongl.payparent.utils.HttpUtil;
import com.dongl.payparent.utils.Sign;
import com.dongl.payparent.utils.XmlUtil;
 ...
 * @author D-L
 * @version 1.0.0
 * @ClassName WxOrderServiceImpl.java
 * @Description
 * @createTime 2021-09-16 16:51:00
 */
@Service
